...
public class Five4 extends Activity {
    private WebView webview;
    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.five4);
        ...
        gobackActivityButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                myIntent = new Intent(Five4.this, MainActivity.class);
        ...
        //加载需要显示的网页
        webview.loadUrl("http://zhushou.360.cn/detail/index/soft_id/3305017");
        //设置Web视图
